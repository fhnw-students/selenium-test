...
public class WebTest {
	...
	public void setUp() throws URISyntaxException {
		...
		URL resource = getClass().getClassLoader().getResource("ch/iseli/ken/test/web/chromedriver.exe");
	...
	public void test() {
		...
		// Exactly two elements with class "new" in the header are to be present
		By classNameNew = By.className("new");
		List<WebElement> headerWithClassNewElements = driver.findElements(classNameNew);
		Assert.assertEquals(headerWithClassNewElements.size(), 2);
